    ...
    def __to_dict__(self, seen=None) -> Dict[str, Any]:
        ...
        def convert_value(value):
            ...
            if isinstance(value, datetime):
                ...
                return {convert_value(str(k)): convert_value(v) for k, v in value.items()}
        ...
        return {key: convert_value(value) for key, value in self.__dict__.items() if key not in ['audit_config', 'provider', 'session','regional_clients','client','thread_pool','fixer_config']}
